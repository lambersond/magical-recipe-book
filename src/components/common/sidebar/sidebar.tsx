  ...
  return (
    <>
      ...
      <div
        ref={sidebarRef}
        data-testid='sidebar'
        className={`overflow-y-auto max-h-[calc(100vh_-_64px)] fixed top-16 h-full bg-card shadow-lg transform transition-transform z-50 ${currentSide.position} ${currentSide.transform} ${className}`}
      >
