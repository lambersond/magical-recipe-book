  ...
  return (
    <main className='pt-8 pb-20 sm:p-20 flex flex-col items-center gap-4'>
      <div className='max-w-6xl mx-auto'>
        {/* Overview */}
        <div className='bg-stone-800 rounded-lg shadow-lg p-8 mb-8'>
        ...
        <div className='bg-stone-800 rounded-lg shadow-lg p-8 mb-8'>
          ...
          <div className='grid lg:grid-cols-2 gap-8'>
            <div>
              ...
              <div className='bg-paper rounded-lg p-4 text-text-primary/90'>
          ...
          <div className='mt-6'>
            <h3 className='text-xl font-semibold text-text-primary mb-4'>
              Magical Ingredient Rarity
            </h3>
            <div className='grid md:grid-cols-3 gap-4'>
              <div className='bg-paper rounded-lg p-4 text-center'>
                <h4 className='font-bold text-lime-300'>Uncommon</h4>
                <p className='text-2xl font-bold text-lime-500'>DC 15</p>
              </div>
              <div className='bg-paper rounded-lg p-4 text-center'>
                <h4 className='font-bold text-blue-300'>Rare</h4>
                <p className='text-2xl font-bold text-blue-500'>DC 20</p>
              </div>
              <div className='bg-paper rounded-lg p-4 text-center'>
                <h4 className='font-bold text-purple-300'>Epic</h4>
                <p className='text-2xl font-bold text-purple-500'>DC 25</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className='bg-stone-800 rounded-lg shadow-lg p-8 mb-8'>
          ...
          <div className='grid md:grid-cols-3 gap-6'>
            <div className='bg-paper rounded-lg p-6 border-l-4 border-red-500'>
            ...
            <div className='bg-paper rounded-lg p-6 border-l-4 border-gray-500'>
            ...
            <div className='bg-paper rounded-lg p-6 border-l-4 border-green-500'>
